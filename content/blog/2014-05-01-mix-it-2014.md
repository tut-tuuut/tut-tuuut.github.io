...
Cette année, j’ai été pour la première fois au [Mix-IT][mix-it], un cycle de conférences organisé par le JUG (Java User Group) et le CARA (Club Agile Rhône-Alpes). Traditionnellement, les thèmes tournent autour de l’agilité et de la technique.<!-- more -->
