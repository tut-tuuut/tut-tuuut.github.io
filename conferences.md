...
Je suis occasionnellement oratrice lors de conférences techniques. Mes sujets de prédilection couvrent aussi bien les méthodes de travail que les sujets plus techniques.
## 2025

- [**Europe, Django and 2FA**](https://www.youtube.com/watch?v=jrDCmuD9cBc), le 25 avril à la Djangocon Europe à Dublin. Condensation et traduction en anglais de la conférence de Paris Web 2024 sur la double authentification. Beaucoup de premières fois pour cette conférence de 20 minutes dans un franglais très prononcé. (Mes blagues ont quand même fonctionné, alors ça va.)
...
* [**Palmarès 2021 des idées fausses sur l'accessibilité numérique**](https://www.paris-web.fr/2021/conference/palmares-2021-des-idees-fausses-sur-laccessibilite-numerique), à Paris Web (en ligne). Venez pour les idées fausses, restez pour les calembours.

## 2020

- [**Recettes de communication efficace au travail**](https://www.youtube.com/watch?v=bqxZkpPY9tE), 22 octobre pour le forum PHP en ligne. Comment j'ai utilisé au travail les astuces censées, d'après les livres de parentalité positive, m'aider à communiquer avec mes enfants.

## 2018

* **Tempête de boulettes géantes** : après une expérience de première main, réflexion sur les erreurs humaines causant des incidents en production. [Le 4 octobre à Paris Web](https://www.paris-web.fr/2018/conferences/tempete-de-boulettes-geantes.php), [le 25 octobre au BlendWebMix](https://www.youtube.com/watch?v=OasaWMC-zPs). 
